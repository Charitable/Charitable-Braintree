 ...
 */
add_filter( 'charitable_payment_gateways', [ 'Charitable_Gateway_Braintree', 'register_gateway' ] );
 ...
 */
add_action( 'charitable_form_after_fields', [ 'Charitable_Gateway_Braintree', 'maybe_setup_scripts_in_donation_form' ] );
 ...
 */
add_action( 'charitable_campaign_loop_after', [ 'Charitable_Gateway_Braintree', 'maybe_setup_scripts_in_campaign_loop' ] );
 ...
 */
add_action( 'charitable_donation_form_gateway_fields', [ 'Charitable_Gateway_Braintree', 'setup_braintree_payment_fields' ], 10, 2 );
 ...
 */
add_filter( 'charitable_validate_donation_form_submission_gateway', [ 'Charitable_Gateway_Braintree', 'validate_donation' ], 10, 3 );
 ...
 */
add_filter( 'charitable_donation_form_submission_values', [ 'Charitable_Gateway_Braintree', 'set_submitted_braintree_token' ], 10, 2 );
 ...
 */
add_filter( 'charitable_process_donation_braintree', [ 'Charitable_Gateway_Braintree', 'process_donation' ], 10, 3 );
